...
export default function QRPenumpangPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px' }}>
      ...
      <h1 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '8px' }}>Pesan Ojek</h1>
      <p style={{ color: '#9ca3af', marginBottom: '32px', textAlign: 'center' }}>Klik tombol di bawah untuk pesan ojek lewat Telegram</p>
      ...
      <p style={{ color: '#6b7280', fontSize: '12px', marginTop: '4px' }}>
        Ketik PESAN setelah membuka bot
      </p>
    </div>
  )
}
