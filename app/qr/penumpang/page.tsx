...
export default function QRPenumpangPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px' }}>
      ...
      <h1 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '8px' }}>Daftar sebagai Penumpang</h1>
      <p style={{ color: '#9ca3af', marginBottom: '32px', textAlign: 'center' }}>Scan QR ini untuk menghubungkan WhatsApp kamu ke Nemu</p>
